package com.study.refactoring.longFunction.introduceParameterObject;
...
public class StudyDashboard {
    ...
    // Participant p, int totalNumberOfEvents 를 하나의 자료구조로 만들기
    // record 로 만들었다가 totalNumberOfEvents를 StudyDashboard의 field로 만들기로 변경
